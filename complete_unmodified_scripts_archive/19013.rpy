...
window show
with fade_in
c23 '[convertstrid(1216114)]' (what_size=(gui.text_size*0.9))
$ update_portrait('oc002_01 12', 'p2', [r(-3), dark], 5)
$ update_portrait('sc049_01 5', 'p56', [l(-8), light, flip], 6)
c561 '[convertstrid(1216115)]' (what_size=(gui.text_size*0.9))
hide p2
$ update_portrait('sc049_01 5', 'p56', [l(-8), dark, flip], 5)
$ update_portrait('oc001_01 8', 'p1', [r(-2), light], 6)
c13 '[convertstrid(1216116)]' (what_size=(gui.text_size*0.9))
hide p1
$ update_portrait('oc002_01 10', 'p2', [r(-3), light], 6)
c23 '[convertstrid(1216117)]' (what_size=(gui.text_size*0.9))
$ update_portrait('oc002_01 10', 'p2', [r(-3), dark], 5)
$ update_portrait('sc049_01 5', 'p56', [l(-8), light, flip], 6)
c561 '[convertstrid(1216118)]' (what_size=(gui.text_size*0.9))
$ update_portrait('sc049_01 5', 'p56', [l(-8), light, flip], 6)
...
menu:
    extend ""
    '[convertstrid(1216141)]':
        call avg19015
    '[convertstrid(1216142)]':
        call avg19016
    '[convertstrid(1216143)]':
        call avg19017
return