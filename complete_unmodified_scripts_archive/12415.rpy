...
c41 '[convertstrid(1142735)]'
$ update_portrait('oc004_01 1', 'p4', [l(-5), light, flip], 6)
c41 '[convertstrid(1142736)]'
hide p4
...
menu:
    extend ""
    '[convertstrid(1142752)]':
        call avg12416
    '[convertstrid(1142753)]':
        call avg12417
    '[convertstrid(1142754)]':
        call avg12418
return