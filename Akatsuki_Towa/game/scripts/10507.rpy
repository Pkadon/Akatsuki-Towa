...
window show
with fade_in
c12021 '[convertstrid(1150376)]'
c12021 '[convertstrid(1150377)]'
$ update_portrait('oc001_01 10', 'p1', [r(-2), light], 6)
play sfxvoice "avg_vocal_na20.ogg"
c13 '[convertstrid(1150378)]'
$ update_portrait('oc001_01 10', 'p1', [r(-2), dark], 5)
c12021 '[convertstrid(1150379)]'
hide p1
$ update_portrait('st041_01 5', 'p240', [r_entrance(-1), light], 6)
c2403 '[convertstrid(1150380)]'
hide p240
c0 '[convertstrid(1150381)]'
$ update_portrait('oc003_01 4', 'p3', [r_exit(-6), light], 6)
c33 '[convertstrid(1150382)]'
hide p3
c12021 '[convertstrid(1150383)]'
$ update_portrait('st041_01 5', 'p240', [r_entrance(-1), light], 6)
c2403 '[convertstrid(1150384)]'
$ update_portrait('st041_01 5', 'p240', [r(-1), dark], 5)
$ update_portrait('oc002_01 10', 'p2', [l(-3), light, flip], 6)
c21 '[convertstrid(1150385)]'
$ update_portrait('oc002_01 8', 'p2', [l(-3), l_shake, light, flip], 6)
c21 '[convertstrid(1150386)]'
hide p2
hide p240
