...
c13 '[convertstrid(2102041)]'
$ update_portrait('oc001_01 1', 'p1', [r(-2), light], 5)
c13 '[convertstrid(2102042)]'
$ update_portrait('oc001_01 1', 'p1', [r(-2), dark], 5)
$ update_portrait('sc051_01 4', 'p58', [l_entrance(-32), light, flip], 6)
c581 '[convertstrid(2102043)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102044)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), dark, flip], 6)
$ update_portrait('oc001_01 2', 'p1', [r(-2), light], 5)
c13 '[convertstrid(2102045)]'
$ update_portrait('oc001_01 2', 'p1', [r(-2), dark], 5)
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102046)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102047)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), dark, flip], 6)
$ update_portrait('oc001_01 1', 'p1', [r(-2), light], 5)
c13 '[convertstrid(2102048)]'
$ update_portrait('oc001_01 1', 'p1', [r(-2), dark], 5)
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102049)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102050)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102051)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), dark, flip], 6)
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 5)
c13 '[convertstrid(2102052)]'
$ update_portrait('oc001_01 2', 'p1', [r(-2), light], 5)
c13 '[convertstrid(2102053)]'
$ update_portrait('oc001_01 2', 'p1', [r(-2), dark], 5)
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102054)]'
$ update_portrait('sc051_01 1', 'p58', [l(-32), dark, flip], 6)
$ update_portrait('oc001_01 12', 'p1', [r(-2), r_shake, light], 5)
c13 '[convertstrid(2102055)]'
$ update_portrait('oc001_01 12', 'p1', [r(-2), dark], 5)
$ update_portrait('sc051_01 4', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102056)]'
$ update_portrait('sc051_01 4', 'p58', [l(-32), dark, flip], 6)
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 5)
c13 '[convertstrid(2102057)]'
stop music
scene avg_bg_070
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 5)
$ update_narrator('c13')
...
$ update_portrait('sc051_01 1', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102065)]'
$ update_portrait('sc051_01 4', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102066)]'
$ update_portrait('sc051_01 4', 'p58', [l(-32), dark, flip], 6)
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 5)
c13 '[convertstrid(2102067)]'
$ update_portrait('oc001_01 4', 'p1', [r(-2), dark], 5)
$ update_portrait('sc051_01 4', 'p58', [l(-32), light, flip], 6)
c581 '[convertstrid(2102068)]' with shake
return