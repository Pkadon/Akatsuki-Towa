...
hide p2
$ update_portrait('oc003_01 10', 'p3', [l_entrance(-6), light, flip], 6)
c31 '[convertstrid(1130859)]'
$ update_portrait('oc003_01 10', 'p3', [l(-6), dark, flip], 5)
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 6)
c13 '[convertstrid(1130860)]'
hide p3
$ update_portrait('oc001_01 4', 'p1', [r(-2), dark], 5)
...
c23 '[convertstrid(1130870)]'
$ update_portrait('oc002_01 8', 'p2', [r(-3), dark], 5)
$ update_portrait('sc038_01 1', 'p45', [l(-1), light, flip], 6)
c451 '[convertstrid(1130871)]'
$ update_portrait('sc038_01 1', 'p45', [l(-1), dark, flip], 5)
$ update_portrait('oc002_01 4', 'p2', [r(-3), light], 6)
c23 '[convertstrid(1130872)]'
$ update_portrait('oc002_01 4', 'p2', [r(-3), dark], 5)
$ update_portrait('sc038_01 5', 'p45', [l(-1), light, flip], 6)
c451 '[convertstrid(1130873)]'
hide p45
$ update_portrait('sc039_01 5', 'p46', [l(-13), light, flip], 6)
