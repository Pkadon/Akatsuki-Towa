...
c23 '[convertstrid(1007661)]'
hide p1
hide p2
$ update_portrait('oc002_01 18', 'p2', [r(-3), light], 6)
$ update_narrator('c23')
with fade
c23 '[convertstrid(1007662)]'
$ update_portrait('oc002_01 18', 'p2', [r(-3), dark], 5)
$ update_portrait('oc001_01 4', 'p1', [l(-2), light, flip], 6)
c11 '[convertstrid(1007317)]'
hide p1
hide p2
c0 '[convertstrid(1007663)]'
...
$ update_portrait('oc001_01 10', 'p1', [l(-2), dark, flip], 5)
c6543 '[convertstrid(1007330)]'
$ update_portrait('oc001_01 2', 'p1', [l(-2), light, flip], 6)
c11 '[convertstrid(1007331)]'
$ update_portrait('oc001_01 2', 'p1', [l(-2), dark, flip], 5)
c6543 '[convertstrid(1007333)]'
$ update_portrait('oc002_01 8', 'p2', [r(-3), light], 6)
