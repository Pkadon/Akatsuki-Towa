...
$ update_portrait('oc006_01 1', 'p6', [r_exit(-5), light], 5)
...
$ update_portrait('st042_01 1', 'p241', [r_entrance(-14), light], 5)
...
$ update_portrait('st043_01 2', 'p242', [l(-17), dark, flip], 6)
$ update_portrait('st042_01 1', 'p241', [r(-14), light], 5)
...
$ update_portrait('st043_01 1', 'p242', [l(-17), dark, flip], 6)
$ update_portrait('st042_01 5', 'p241', [r(-14), light], 5)
c2413 '[textdict[1005982]]'
$ update_portrait('st042_01 5', 'p241', [r(-14), dark], 5)
$ update_portrait('st043_01 2', 'p242', [l(-17), light, flip], 6)
c2421 '[textdict[1005983]]'
$ update_portrait('st043_01 2', 'p242', [l(-17), dark, flip], 6)
$ update_portrait('st042_01 2', 'p241', [r(-14), light], 5)
c2413 '[textdict[1005984]]'
$ update_portrait('st042_01 2', 'p241', [r(-14), dark], 5)
$ update_portrait('st043_01 5', 'p242', [l(-17), light, flip], 6)
c2421 '[textdict[1001686]]'
$ update_portrait('st043_01 5', 'p242', [l(-17), dark, flip], 6)
$ update_portrait('st042_01 5', 'p241', [r(-14), light], 5)
...
$ update_portrait('st043_01 2', 'p242', [l(-17), dark, flip], 6)
$ update_portrait('st042_01 2', 'p241', [r(-14), r_shake, light], 5)
...
hide p3
$ update_portrait('st043_01 4', 'p242', [r(-17), light], 5)
...
$ update_portrait('st043_01 2', 'p242', [r(-17), light], 5)
...
$ update_portrait('st043_01 4', 'p242', [l(-17), dark, flip], 6)
$ update_portrait('oc001_01 7', 'p1', [r(-2), light], 5)
...
$ update_portrait('st042_01 4', 'p241', [r(-14), light], 5)
...
$ update_portrait('uc002_03 2', 'p543', [r(-23), light], 5)
...
$ update_portrait('uc002_03 2', 'p543', [r_exit(-23), light], 5)
...
$ update_portrait('st043_01 2', 'p242', [r(-17), r_shake, light], 5)
...
hide p241
$ update_portrait('st043_01 5', 'p242', [r(-17), light], 5)
