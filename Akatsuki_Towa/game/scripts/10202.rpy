...
$ update_portrait('st028_02 4', 'p666', [r(8), light], 5)
...
hide p1
$ update_portrait('sc038_01 3', 'p667', [r_entrance(-1), light], 5)
play sfx2 "fight_6010.ogg"
c6673 '[textdict[1004313]]'
hide p667
$ update_portrait('sc039_01 3', 'p668', [r(-13), light], 5)
...
hide p1
$ update_portrait('sc038_01 4', 'p667', [l(-1), dark, flip], 6)
$ update_portrait('sc060_01 1', 'p669', [r(-16), light], 5)
...
hide p669
$ update_portrait('sc045_01 4', 'p670', [l(-11), dark, flip], 6)
$ update_portrait('sc040_01 4', 'p671', [r(-9), light], 5)
...
hide p671
$ update_portrait('sc041_01 1', 'p672', [l(-9), dark, flip], 6)
