...
c23 '[convertstrid(1152316)]'
hide p240
$ update_portrait('oc002_01 17', 'p2', [r(-3), dark], 5)
$ update_portrait('oc003_01 4', 'p3', [l(-6), light, flip], 6)
c31 '[convertstrid(1152317)]'
hide p2
$ update_portrait('oc003_01 4', 'p3', [l(-6), dark, flip], 6)
$ update_portrait('oc004_01 4', 'p4', [r(-5), light], 5)
c43 '[convertstrid(1152318)]'
hide p4
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 5)
c13 '[convertstrid(1152319)]'
$ update_portrait('oc001_01 4', 'p1', [r(-2), dark], 5)
$ update_portrait('oc003_01 4', 'p3', [l(-6), light, flip], 6)
c31 '[convertstrid(1152320)]'
hide p1
$ update_portrait('oc003_01 4', 'p3', [l(-6), dark, flip], 6)
$ update_portrait('oc004_01 7', 'p4', [r(-5), light], 5)
c43 '[convertstrid(1152321)]'
hide p3
hide p4
$ update_portrait('oc001_01 16', 'p1', [r(-2), light], 5)
$ update_narrator('c13')
with fade
c13 '[convertstrid(1152322)]'
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 5)
c13 '[convertstrid(1152323)]'
$ update_portrait('oc001_01 4', 'p1', [r(-2), dark], 5)
$ update_portrait('oc004_01 4', 'p4', [l(-5), light, flip], 6)
c41 '[convertstrid(1152324)]'
hide p4
hide p1
hide Image8001
$ update_portrait('sc007_01 2', 'p15', [r(-17), light], 5)
...
with fade
c153 '[convertstrid(1152325)]'
$ update_portrait('sc007_01 2', 'p15', [r(-17), dark], 5)
$ update_portrait('st041_01 4', 'p240', [l_entrance(-1), light, flip], 6)
c2401 '[convertstrid(1152326)]'
$ update_portrait('st041_01 4', 'p240', [l(-1), light, flip], 6)
c2401 '[convertstrid(1152327)]'
hide p15
$ update_portrait('st041_01 4', 'p240', [l(-1), dark, flip], 6)
$ update_portrait('oc004_01 4', 'p4', [r(-5), light], 5)
c43 '[convertstrid(1152328)]'
hide p240
$ update_portrait('oc004_01 4', 'p4', [r(-5), dark], 5)
$ update_portrait('sc007_01 4', 'p15', [l(-17), l_shake, light, flip], 6)
c151 '[convertstrid(1152329)]'
hide p15
$ update_portrait('st041_01 4', 'p240', [l(-1), light, flip], 6)
c2401 '[convertstrid(1152330)]'
$ update_portrait('st041_01 4', 'p240', [l(-1), light, flip], 6)
c2401 '[convertstrid(1152331)]'
hide p4
$ update_portrait('st041_01 4', 'p240', [l(-1), dark, flip], 6)
$ update_portrait('oc001_01 4', 'p1', [r(-2), light], 5)
c13 '[convertstrid(1152332)]'
$ update_portrait('oc001_01 4', 'p1', [r(-2), dark], 5)
$ update_portrait('st041_01 1', 'p240', [l(-1), light, flip], 6)
c2401 '[convertstrid(1152333)]'
hide p240
$ update_portrait('st050_01 5', 'p257', [l(-11), light, flip], 6)
c2571 '[convertstrid(1152334)]'
return