...
window show
with fade_in
c23 '[convertstrid(1216111)]' (what_size=(gui.text_size*0.9))
hide p2
$ update_portrait('oc001_01 1', 'p1', [r(-2), light], 6)
c13 '[convertstrid(1216112)]' (what_size=(gui.text_size*0.9))
$ update_portrait('oc001_01 1', 'p1', [r(-2), dark], 5)
$ update_portrait('sc049_01 1', 'p56', [l(-8), light, flip], 6)
c561 '[convertstrid(1216113)]' (what_size=(gui.text_size*0.9))
