...
hide p2
$ update_portrait('st008_01 1', 'p208', [mid(-19), light], 6)
c2083 '[convertstrid(1001692)]'
$ update_portrait('st008_01 1', 'p208', [mid(-19), light], 6)
c2083 '[convertstrid(1001693)]'
hide p208
$ update_portrait('oc002_01 15', 'p2', [mid(-3), light], 6)
...
hide p1
$ update_portrait('st008_01 1', 'p208', [mid(-19), light], 6)
c2083 '[convertstrid(1001696)]'
$ update_portrait('st008_01 5', 'p208', [mid(-19), light], 6)
c2083 '[convertstrid(1001697)]'
$ update_portrait('st008_01 1', 'p208', [mid(-19), light], 6)
c2083 '[convertstrid(1001698)]'
hide p208
...
hide p1
$ update_portrait('st007_01 1', 'p207', [mid(-6), light], 6)
c2073 '[convertstrid(1001701)]'
hide p207
$ update_portrait('st003_01 1', 'p203', [mid(-7), light], 6)
c2033 '[convertstrid(1001702)]'
hide p203
